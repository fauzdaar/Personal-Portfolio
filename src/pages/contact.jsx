export default function Contact() {
  return (
    <section data-aos="fade-up" id="contact" className="min-h-screen bg-white text-black dark:bg-gray-900 dark:text-white py-12 px-6 transition-colors duration-300">
